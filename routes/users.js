...
const { users } = require("../data/users.json");// imported user.json
 ...
 * Route : /users/:id
 * Method: DELETE
 * Discription: Deleteing a user by id
 * Access : Public
 * Parameters : id
 * 
 */
 ...
 * Method: GET
 * Discription:Get all user  subscription details
 * Access : Public
 * Parameters : id
...
router.get("/subscription-details/:id", (req, res) => {
    ...
    console.log("Subcription Expiry Date", subscriptionExpiration);
